...
including helpers for file handling, text processing, error management, 
JSON serialization, and working with web content.

The utilities in this module are designed to be general-purpose and reusable,
supporting the core functionality of the agent framework without being tied
