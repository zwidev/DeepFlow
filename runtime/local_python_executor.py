"""
Local Python Executor Module
==========================

This module provides an isolated Python execution environment for safely running
code generated by the agent. It implements sandboxing, resource control, and
proper error handling to prevent security issues while allowing agents to
execute Python code as part of their reasoning process.

The module includes classes for creating and managing Python interpreters with
configurable security settings, import whitelisting, and resource limitations.
