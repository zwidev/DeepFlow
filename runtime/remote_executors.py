...
"""
Remote Executors Module
=====================

This module provides execution environments for running agent code in remote
or containerized environments. It includes implementations for Docker-based
execution and E2B cloud execution, ensuring secure and isolated code execution
with proper resource management.

Remote executors allow agents to run code with dependencies and system requirements
that might not be available in the local environment, while maintaining security
and observability.
