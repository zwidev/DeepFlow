...
"""
Default Tools Module
==================

This module provides a collection of ready-to-use tools for agents, covering common
functionality like web search, Python code execution, web browsing, and more.

These tools follow the standard Tool interface and can be directly added to any agent
to provide it with specific capabilities. Each tool is designed to handle a particular
task domain and includes proper input/output typing and descriptive documentation.
